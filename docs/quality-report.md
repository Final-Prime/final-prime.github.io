...
- Merged the duplicated Metro forced-colors rules into one final high-contrast block so canonical shell styles cannot shadow Canvas borders or decoration removal.
