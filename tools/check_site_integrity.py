...
HOMEPAGE_SELECTED_WORK_CONTRACT = {
    "index.html": (
        '<link rel="stylesheet" href="/assets/home-v1.css?v=20260718-4">',
    ...
    "assets/home-v1.css": (
        ...
        "width: 22px;",
        "height: 24px;",
        "linear-gradient(rgba(10, 232, 247, 0.84), rgba(10, 232, 247, 0.84)) left center / 2px 18px no-repeat,",
        "linear-gradient(var(--text), var(--text)) center / 2px 24px no-repeat,",
        "linear-gradient(rgba(245, 5, 77, 0.88), rgba(245, 5, 77, 0.88)) right center / 2px 18px no-repeat;",
