...
HEADER_GLITCH_CONTRACT = {
    ...
    "assets/signal-glitch.css": (
        ...
        "var(--echo-near) 0 0 rgba(var(--echo-rgb), 0.64)",
        "var(--echo-mid) 0 1px rgba(var(--echo-rgb), 0.32)",
        "var(--echo-far) 0 2.4px rgba(var(--echo-rgb), 0.14)",
        '.site-header .brand-word-final::before {',
        'content: "FINAL";',
        "transform: translateX(-2px);",
        '.site-header .brand-word-prime::before {',
        'content: "PRIME";',
        "transform: translateX(2px);",
        "-1px -1px 0.2px rgba(10, 232, 247, 0.72)",
        "1px 1px 0.2px rgba(245, 5, 77, 0.78)",
