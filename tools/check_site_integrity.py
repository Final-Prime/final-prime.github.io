...
HOMEPAGE_IDENTITY_REQUIRED_TOKENS = (
    ...
    'is control.',
    'Final Prime is an <b>independent</b>, <b>cross-domain</b> research and engineering effort',
    'created and operated by <b>Daniel Kenessy</b>',
    'pursuing a more <b>unified understanding</b> of <b>complex systems</b>',
    'class="hero-intro hero-method"',
    'Rather than treating <b>visible symptoms</b>',
    'the <b>logic</b> that makes them possible.',
    'tests <b>hypotheses</b>, develops <b>theory</b>, and builds <b>software</b>',
