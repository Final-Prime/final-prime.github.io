...
HOMEPAGE_FIELDS_CONTRACT = {
    "index.html": (
        '<link rel="stylesheet" href="/assets/hero.css?v=20260718-9">',
        '<link rel="stylesheet" href="/assets/home-v1.css?v=20260718-15">',
    ...
    "assets/home-v1.css": (
        ...
        "d='M2%2012L4%2014L2%2016' stroke='%230ae8f7' stroke-opacity='.18'",
        "d='M20%203L29%2014L20%2025' stroke='%230ae8f7' stroke-opacity='.82'",
        "d='M32%202L35%2014L32%2026L29%2014Z' stroke='%23f2f4f5' stroke-opacity='.96'",
        "d='M44%203L35%2014L44%2025' stroke='%23f5054d' stroke-opacity='.86'",
        "d='M62%2012L60%2014L62%2016' stroke='%23f5054d' stroke-opacity='.20'",
        ...
        "@media (max-width: 1080px)",
        "[data-field-layer]::before { top: 34px; width: 56px; height: 25px; }",
        "@media (prefers-reduced-transparency: reduce)",
        "@media (forced-colors: active)",
        "@media print",
    ),
