...
HOMEPAGE_FIELDS_CONTRACT = {
    "index.html": (
        '<link rel="stylesheet" href="/assets/hero.css?v=20260718-9">',
        '<link rel="stylesheet" href="/assets/home-v1.css?v=20260719-24">',
        ...
        '<h3 id="theory-feature-title"><span class="field-title-primary">A/SYNC <span class="field-title-mark">/</span></span> <span class="field-title-accent">Theoretical foundations</span></h3>',
        '<h3 id="async-title"><span class="field-title-primary">A<span class="field-title-mark">/</span>SYNC</span></h3>',
        '<h3 id="metro-title"><span class="field-title-primary">Metro 2033</span> <span class="field-title-accent">Redux</span></h3>',
